...
\begin{frame}{Synchrone bewegte Uhren}
    ...
    \only<2->{
        ...
        \begin{align*}
            ...
            \Aboxed{
            \tfrac{1}{2}\left(\tau_1 - \tau_0\right)     &=  \tau_2
            }
        \end{align*}
    }
\end{frame}
...
%            ?   &?   &?    &? \\ 
%            ?   &?   &?    &? \\ 
%            -\tfrac{v\cdot a\left( v \right)}{V^2-v^2} 
%            &0
%            &0
%            &a\left( v \right) 
%        \end{bmatrix}
...
\begin{frame}{Geschwindigkeit eines Lichtstrahles entlang $\eta$ und $\zeta$}
    \begin{figure}[h]
            \centering
            \includegraphics[width = 0.7\textwidth]{geschwEta}
    \end{figure}
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \begin{figure}[h]
                    \centering
                    \includegraphics[width = 0.8\textwidth]{geschwEtaVektor}
            \end{figure}
        \end{column}
        \begin{column}{0.5\textwidth}  %%<--- here
            \begin{align*}
...
\begin{frame}{Bestimmung von $\varphi(v)$ durch zwei Überlegungen}
    \begin{enumerate}
        \item Bewegtes System im bewegten System
            \begin{itemize}
                \item Forderung:
                \begin{align*}
                    \varphi(v) \varphi(-v) = 1
        ...
        \only<1>{
            \begin{figure}[h]
                \centering
                \includegraphics[width = 0.5\textwidth]{forderungPhi1}
            \end{figure}
        }
        \only<2->{
            \item $\varphi(v)$ skaliert Längen im bewegten System bei Beobachtung aus dem ruhenden System. Wir fordern, dass diese Skalierung unabhängig vom Vorzeichen der Geschwindigkeit ist.
                \begin{itemize}
                    \item Forderung:
                        \begin{align*}
                            \varphi(v) = \varphi(-v)
    ...
    \visible<3->{
        \begin{itemize}
            \item Aus den Forderungen folgt
                \begin{align*}
                    \varphi(v) = 1
                \end{align*}
        \end{itemize}
...
\begin{frame}{Bedeutung}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[height = 0.3\textwidth]{minko}
